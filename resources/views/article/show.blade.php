...
<html lang="en">
    ...
    <body>
    	<div id="container" style="padding: 50px;">
    		...
    		<hr>
    		<div id="date" style="text-align: right;">{{ $article->updated_at }}</div>
    		...
    		<div class="comments" style="margin-top: 50px;">
    			...
    			<div id="new">
    				<form action="{{url('comment')}}" method="POST">
    					...
    					<div class="form-group">
    						<label>Content</label>
    						<textarea name="content" id="newFormContent" rows="10" class="form-control" required="required"></textarea>
    					</div>
    					<button class="btn btn-lg btn-success col-lg-12" type="submit">Submit</button>
    				</form>
    			</div>
